...
CREATE TABLE `notifications` (
  `id` int(50) NOT NULL,
  `notification_title` varchar(600) COLLATE utf8mb4_bin NOT NULL,
  `details` varchar(900) COLLATE utf8mb4_bin NOT NULL,
  `name` varchar(600) COLLATE utf8mb4_bin NOT NULL,
  `date` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
...
('11', 'new update', 'hello everyone ', 'shrey', '2020-06-21 08:52:28');
